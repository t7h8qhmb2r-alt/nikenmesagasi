...
import { Users, Beer, Wine, Search, Lightbulb, Martini, GlassWater } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-white relative overflow-hidden flex flex-col items-center justify-center p-6 text-[#333]">
      <div className="absolute inset-0 bg-dot opacity-10"></div>
      
      {/* 散りばめられたお酒アイコン */}
      <Beer className="absolute top-[10%] left-[10%] text-yellow-400 opacity-20 animate-float" size={80} />
      <Wine className="absolute top-[25%] right-[10%] text-red-400 opacity-20 animate-float" style={{animationDelay:'1s'}} size={60} />
      <Martini className="absolute bottom-[20%] left-[15%] text-pink-400 opacity-20 animate-float" style={{animationDelay:'2s'}} size={70} />
      <GlassWater className="absolute bottom-[10%] right-[20%] text-blue-400 opacity-20 animate-float" style={{animationDelay:'0.5s'}} size={60} />
      ...
      <div className="max-w-md w-full relative z-10 space-y-10">
        <div className="text-center flex flex-col items-center">
          ...
          <h1 className="text-4xl font-black tracking-tighter uppercase">2軒目研究所</h1>
          <p className="text-gray-500 font-bold mt-1 uppercase tracking-widest text-[10px]">The Best Lab for Your Night</p>
        </div>

        <div className="bg-white lab-card p-8 space-y-8 shadow-[12px_12px_0px_#333]">
          <div className="space-y-6 font-black">
            ...
            <div className="flex items-center gap-4 border-b-4 border-[#333] pb-2">
              <Beer className="text-yellow-500" size={28} />
              <div className="flex-1">
